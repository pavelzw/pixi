...
```toml
[project]
# This is defaulted to the directory name or the name given to pixi init
name = "my_project"
version = "0.1.0"
description = "Add a short description here"
# Gets the information from you currently configured git user.
authors = ["John Doe <john@prefix.dev>"]
# Defaults to conda-forge, add in vector style more channels if needed.
channels = ["conda-forge"]
# Defaults to the platform you are currently on but add the platform you want to support as needed.
platforms = ["linux-64"]
